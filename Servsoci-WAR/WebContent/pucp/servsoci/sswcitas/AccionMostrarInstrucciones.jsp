...
<tr >
<td ><font class="pucpSubTitulo">Declaraci�n Jurada Familiar&nbsp;</font></td>
</tr>
</table>
<br>
...
<br>    
  ...
  <tr><td>
	...
	<!-- <p>Para descargar el Manual, haga click <a href="javascript:mypopup('<%=declaracionJuradaData.getTramite().trim()%>');">Aqui<br><img src="jsp/imagen_adobe.gif" border="0"></a> --> 
	   ...
	   <br>
	  <br><b><input type="checkbox" name="boletin" value="OFF" unchecked onclick="habilitaDeshabilita(this.form)" >Acepto haber le�do y entendido el manual de instrucciones de la DJF </b>
  </TD></TR>
    </TABLE>
...
<%-- Incluimos el pie que es un html est�tico --%>
